...
SymExpr _sym_build_subss(SymExpr a, SymExpr b);
SymExpr _sym_build_mulss(SymExpr a, SymExpr b);
SymExpr _sym_build_divss(SymExpr a, SymExpr b);
SymExpr _sym_build_comiss(SymExpr a, SymExpr b);
